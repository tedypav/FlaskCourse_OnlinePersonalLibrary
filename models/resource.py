...
resource_tag = db.Table(
    ...
    db.Column("resource_id", db.Integer, db.ForeignKey("resource.resource_id"), nullable=False),
...
class ResourceModel(db.Model):
    ...
    status = db.Column(db.Enum(ResourceStatus), default=ResourceStatus.pending, nullable=False)
